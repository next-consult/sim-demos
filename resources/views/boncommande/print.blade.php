    ...
    <div>
        <div class="row" style="border-bottom:1px black solid;padding:8px">
            ...
            <div class="col-xs-8"style="margin-top:-20px">
                <h1 style="margin-left:106px">{{ $boncommande->numero }}</h1>
                <span style="float:right;margin-right:42px"><b>DATE:</b>{{ $boncommande->date }}</span>
            </div>
        </div>
        <div class="row" style="margin-top:25px">
            <div class="col-xs-5">
                <p class="addressMySam">
                    <strong style="font-size:22px;text-decoration:capitalize">Fournisseur</strong><br />
                    {{ $boncommande->fournisseur->nom }}<br />
                    {{ $boncommande->fournisseur->adresse }}<br />
            ...
            <div class="col-xs-6">
                <table class="table" style="font-size:12px">
                    <tr>
                        <td>Total : <b>{{ replace(sprintf('%.3f', $boncommande->commande_ttc)) }}</b></td>
                        <td>Devise :<b><?php echo \App\Models\Devise::where('symbole', $boncommande->devise)->first()->code; ?></b></td>
                    </tr>
                    <tr>
                        <td>Offre valable: <b>10 à 15 jours </b></td>
        ...
        <div class="row" style="border-top:1px #DDDDDD solid">
            <div class="col-xs-6" style="border-top:1px #DDDDDD solid">
                <div style="margin-top:12px">
                    <span style="font-size:11px;">{!! nl2br(e($boncommande->condition)) !!}</span>
                </div>
            </div>
            <div class="col-xs-5">
                <table class="table" style="border-top:1px #DDDDDD solid" id="total_table">
                    <tbody>
                        <tr style="border-top:none">
                            <td>Total HT:</td>
                            <td class="text-left">
                                {{ replace(sprintf('%.3f', $boncommande->commande_ht - $boncommande->commande_remise)) }}
                                {{ $boncommande->devise }}
                        ...
                        <tr>
                            <td>Total TVA:</td>
                            <td class="text-left">
                                {{ replace(sprintf('%.3f', $boncommande->commande_tva)) }} {{ $boncommande->devise }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-bold-800 text-left"> <b>
                                    ...
                                    <span class="total"> {{ replace(sprintf('%.3f', $boncommande->commande_ttc)) }}
                                        {{ $boncommande->devise }}
     ...
     <div class="footer">
        <p style="font-size:9px">
			{{$boncommande->entreprise->footer}}
			BIAT SARL;
			@if($boncommande->devise=="TND")
			RIB : 0800 8000 6710 0226 3083;IBAN: TN59 0800 8000 6710 0226 3083;
			@elseif($boncommande->devise=="€")
