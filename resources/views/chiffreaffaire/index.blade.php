                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-multiple js-states form-control form-control-lg shadow-sm" 
                                    name="client_id[]" 
                                    multiple="multiple"
                        ...
                        <div class="col-md-1">
                            <div class="form-group mt-4">
                                <div class="btn-group shadow" style="margin-top: 27px;">
                                    ...
                                    <button type="submit" class="btn btn-success" 
                                        ...
                                        formaction="{{ route('chiffreaffaire.export') }}"
                                        formmethod="GET">
            ...
            <div id="clock" class="widget_card alert">
                ...
                <div class="widget_card_body">
                    ...
                    <div class="widget_text">
                       <h3 id="count_ht">{{ request('tax_type') == 'with_tva' ? '0.000' : $total_ht }}</h3>
                        <p>Total HT</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div id="widget_visitor" class="widget_card alert">
                ...
                <div class="widget_card_body">
                    ...
                    <div class="widget_text">
                        <h3 id="count_tva">{{ request('tax_type') == 'without_tva' ? '0.000' : $total_tva }}</h3>
        ...
        <div class="col-md-6">
            <div id="widget_user" class="widget_card alert">
                ...
                <div class="widget_card_body">
                    ...
                    <div class="widget_text">
  <h3 id="count_paiements_total">{{ request('payment_status') == 'unpaid' ? '0.000' : number_format($paiements, 3, '.', ' ') }}</h3>                        <p>Total Facture Payé</p>
                    </div>
                </div>
            </div>
        </div>
