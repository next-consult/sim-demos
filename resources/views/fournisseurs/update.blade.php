                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Nom"
                                            class="form-control  @error('nom') is-invalid @enderror" name="nom" value="{{$fournisseur->nom}}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Entrer Telephone" class="form-control"
                                            name="telephone" value="{{$fournisseur->telephone}}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer MF" class="form-control" name="mf" value="{{$fournisseur->mf}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Code postal" class="form-control"
                                            name="code_postal" value="{{$fournisseur->code_postal}}">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Entrer votre adresse" class="form-control " name="adresse">{{$fournisseur->adresse}}</textarea>
...
<script>
    ...
    function savefournisseur() {
        ...
        jQuery.ajax({
            ...
            url: "{{ url('/updatestorefournisseur') }}/"+'{{$fournisseur->id}}',
            method: 'post',
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function(result) {
                ...
                if (result.error) {
                    ...
                    Swal.fire({
                        position: 'top-center',
                        icon: 'success',
                        title: 'fournisseur modifié avecc succéss',
