                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                           ...
                                           <input type="date" class="form-control" id="date_facture"
                                            ...
                                            <span class="form-control disabled">{{ $facture->date }}</span>
                                             @endif --}}
                                     <input type="number" class="form-control" id="retenu"  value="{{ $facture->retenu }}"
                                onchange="total_final()" @if($facture->status == 'paye' || $facture->status == 'paye_partielle' || $facture->status == 'valide') disabled @endif>
...
<script>
   ...
   function total_final() {
        ...
        if (total_ttc >= 1000) {
            ...
            console.log(value)
            $("#retenu").val(value)
            montant_retenu = ($("#retenu").val() / 100)
            retenu = total_ttc * montant_retenu
            total_ttc -= retenu
        } else {
            montant_retenu = 0
            retenu = 0
            $("#retenu").val('{{ $facture->retenu }}')
        }
