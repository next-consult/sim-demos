                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Raison" class="form-control  "
                                            name="raison" value="{{ $contactcrm->raison_social }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer prenom" class="form-control  "
                                            name="prenom" value="{{ $contactcrm->prenom }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Poste" class="form-control" name="poste"
                                            value="{{ $contactcrm->poste }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Entrer Telephone" class="form-control"
                                            name="telephone" value="{{ $contactcrm->telephone }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Entrer mobile" class="form-control"
                                            name="mobile" value="{{ $contactcrm->mobile }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Email" class="form-control "
                                            name="email" value="{{ $contactcrm->email }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="secteur">
                                            <option value="Agriculture et agroalimentaire"
                                                {{ $contactcrm->secteur == 'Agriculture et agroalimentaire' ? 'selected' : '' }}>
                                                Agriculture et agroalimentaire
                                            </option>
                                            <option value="Art et divertissement"
                                                {{ $contactcrm->secteur == 'Art et divertissement' ? 'selected' : '' }}>Art
                                                et divertissement</option>
                                            <option value="Automobile"
                                                {{ $contactcrm->secteur == 'Automobile' ? 'selected' : '' }}>Automobile
                                            </option>
                                            <option value="Biotechnologie"
                                                {{ $contactcrm->secteur == 'Biotechnologie' ? 'selected' : '' }}>
                                                Biotechnologie</option>
                                            <option value="Construction et génie civil"
                                                {{ $contactcrm->secteur == 'Construction et génie civil' ? 'selected' : '' }}>
                                                Construction et génie civil
                                            </option>
                                            <option value="Éducation et formation"
                                                {{ $contactcrm->secteur == 'Éducation et formation' ? 'selected' : '' }}>
                                                Éducation et formation</option>
                                            <option value="Énergie et services publics"
                                                {{ $contactcrm->secteur == 'Énergie et services publics' ? 'selected' : '' }}>
                                                Énergie et services publics
                                            </option>
                                            <option value="Fabrication"
                                                {{ $contactcrm->secteur == 'Fabrication' ? 'selected' : '' }}>Fabrication
                                            </option>
                                            <option value="Immobilier"
                                                {{ $contactcrm->secteur == 'Immobilier' ? 'selected' : '' }}>Immobilier
                                            </option>
                                            <option value="Informatique et technologies de l'information"
                                                {{ $contactcrm->secteur == "Informatique et technologies de l'information" ? 'selected' : '' }}>
                                                Informatique et
                                                technologies de l'information</option>
                                            <option value="Marketing et publicité"
                                                {{ $contactcrm->secteur == 'Marketing et publicité' ? 'selected' : '' }}>
                                                Marketing et publicité</option>
                                            <option value="Médias et communication"
                                                {{ $contactcrm->secteur == 'Médias et communication' ? 'selected' : '' }}>
                                                Médias et communication</option>
                                            <option value="Pharmaceutique"
                                                {{ $contactcrm->secteur == 'Pharmaceutique' ? 'selected' : '' }}>
                                                Pharmaceutique</option>
                                            <option value="Restauration et hôtellerie"
                                                {{ $contactcrm->secteur == 'Restauration et hôtellerie' ? 'selected' : '' }}>
                                                Restauration et hôtellerie</option>
                                            <option value="Santé et soins médicaux"
                                                {{ $contactcrm->secteur == 'Santé et soins médicaux' ? 'selected' : '' }}>
                                                Santé et soins médicaux</option>
                                            <option value="Services professionnels"
                                                {{ $contactcrm->secteur == 'Services professionnels' ? 'selected' : '' }}>
                                                Services professionnels</option>
                                            <option value="Télécommunications"
                                                {{ $contactcrm->secteur == 'Télécommunications' ? 'selected' : '' }}>
                                                Télécommunications</option>
                                            <option value="Transport et logistique"
                                                {{ $contactcrm->secteur == 'Transport et logistique' ? 'selected' : '' }}>
                                                Transport et logistique</option>
                                            <option value="Vente au détail et commerce électronique"
                                                {{ $contactcrm->secteur == 'Vente au détail et commerce électronique' ? 'selected' : '' }}>
                                                Vente au détail et
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Adresse" class="form-control"
                                            name="adresse" value="{{ $contactcrm->adresse }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Code postal" class="form-control"
                                            name="code_postal" value="{{ $contactcrm->code_postal }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Linkedin" class="form-control"
                                            name="linkedin" value="{{ $contactcrm->linkedin }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Facebook" class="form-control"
                                            name="facebook" value="{{ $contactcrm->facebook }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Entrer Instagram" class="form-control"
                                            name="instagram" value="{{ $contactcrm->instagram }}">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="  border: 1px solid grey;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id='img_contain'>
                                            @if ($contactcrm->photo != null)
                                                <img id="image-preview"
                                                    align='middle'src="{{ asset('assets/img/' . $contactcrm->photo) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Entrer votre commentaire" class="form-control " name="commentaire">
                                      {{ $contactcrm->comentaire }}
        ...
        <div class="col-md-3">
            <div class="page-box">
                ...
                <table style="margin-top:15px" id="contact_table">
                    <tbody>
                        @foreach ($contactcrm->contacts as $sous)
                            <tr>
                                <td style="width:90%">
                                    <br>
                                    <input type='hidden' class='form-control' placeholder='Nom du contact'
                                        name='id_contact[]' value='{{ $sous->id }}'>
                                    <input type='text' class='form-control' name='poste_contact[]'
                                        placeholder='Poste' value="{{ $sous->poste }}" style='margin-top:5px'>
                                    ...
                                    <input type="number" class="form-control" name="autre_telephone_contact[]"
                                        placeholder="Telephone" style="margin-top:5px" value="{{ $sous->telephone }}">
                                    <input type="text" class="form-control" name="email_contact[]"
                                        placeholder="Email" style="margin-top:5px" value="{{ $sous->email }}">
                                </td>
                                <td>
...
<script>
    ...
    function savecontact() {
        ...
        jQuery.ajax({
            ...
            url: "{{ url('/updatecrmstore') }}/" + '{{ $contactcrm->id }}',
            method: 'post',
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function(result) {
                ...
                if (result.error) {
                    ...
                    Swal.fire({
                        position: 'top-center',
                        icon: 'success',
                        title: 'contact modifié avecc succéss',
