                    ...
                    <div class="form-wrap top-label-exapmple form-layout-page">
                        <form>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Date fin vignette: <span
                                                class="obligatoire">*</span></label>
                                        <input type="date" class="form-control " name="date_vignette">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Kilometrage: <span class="obligatoire">*</span></label>
            ...
            success: function(result) {
                ...
                if (result.error) {
                    ...
                    Swal.fire({
                            position: 'top-center',
                            icon: 'success',
                            title: 'Camion ajouté avecc succéss',
                        ...
                        setTimeout(function() {
                            ...
                            window.location.href =
                                `updatecamions/${result.success_id}`;
