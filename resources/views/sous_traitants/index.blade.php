                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="seipkon-breadcromb-right">
                            <a href="{{ route('soustraitants.add') }}">
                                <button class="btn btn-primary float-right">Ajouter un sous traitant</button>
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton">
                                                <ul class="list-group">
                                                    ...
                                                    <a href="{{ route('soustraitants.update', ['id' => $chauffeur->id]) }}">
