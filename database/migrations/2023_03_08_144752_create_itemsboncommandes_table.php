...
class CreateItemsboncommandesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('itemsboncommandes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('itemsboncommandes');
    }
}
